...
"""
 python inceptionv3_retrain.py --image_dir C:/Users/ChoiSeongYoon/python/trim
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--output_graph',
      type=str,
      default='C:/Users/ChoiSeongYoon/python/tmp/output_graph.pb',
      help='Where to save the trained graph.'
  )
  parser.add_argument(
      '--output_labels',
      type=str,
      default='C:/Users/ChoiSeongYoon/python/tmp/output_labels.txt',
      help='Where to save the trained graph\'s labels.'
  )
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default='C:/Users/ChoiSeongYoon/python/tmp/retrain_logs',
  ...
  parser.add_argument(
      '--model_dir',
      type=str,
      default='C:/Users/ChoiSeongYoon/python/tmp/imagenet',
      help="""\
  ...
  parser.add_argument(
      '--bottleneck_dir',
      type=str,
      default='C:/Users/ChoiSeongYoon/python/tmp/bottleneck',
